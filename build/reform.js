...
(function() {
  ...
  AutocompleteAbstract = (function() {
    ...
    function AutocompleteAbstract(select, options) {
      ...
      this.el.on('setFieldLabel', (function(_this) {
        return function(e, newSelectedItem) {
          return _this.setSelectedItem(newSelectedItem);
        };
      })(this));
      this.refreshState();
    }
      ...
      if (this.floater != null) {
        ...
        if (pos.top + this.floater.outerHeight() > this.height) {
          ...
          if (this.orig.data('shift')) {
            pos.top = pos.top - parseInt(this.orig.data('shift'));
          }
        } else {
